...
const Roadmap = ({ className = "" }) => {
  return (
    <section
      className={`flex flex-col items-start justify-start py-0 px-10 box-border max-w-full text-left text-xl text-gray-400 font-space-grotesk mq450:p-4 mq825:p-4 ${className}`}
    >
